DP = {}
local root = '/mnt/data/rivals112/Rivals/'
...
for _,name in ipairs({'spec.lua','specs.lua','usage.lua','rating.lua','guards.lua','verification.lua','recovery.lua','wow_mock.lua'}) do assert(loadfile(root..'tests/'..name))() end
loadAddon('Core.lua')
