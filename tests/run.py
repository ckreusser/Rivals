...
for name in ("Parser.lua", "Tracker.lua", "Usage.lua", "Rating.lua", "Verification.lua", "Recovery.lua", "Periods.lua", "Theme.lua", "Views.lua", "Promos.lua", "CharacterTab.lua", "Inspect.lua", "Tooltip.lua"):
...
lua.execute((root / "tests" / "guards.lua").read_text(encoding="utf-8"))
...
lua.execute((root / "tests" / "promos.lua").read_text(encoding="utf-8"))
